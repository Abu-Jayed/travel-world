...
import hotel1 from '../../assets/images/hotel/Rectangle 26.png'
import hotel2 from '../../assets/images/hotel/Rectangle 27.png'
import hotel3 from '../../assets/images/hotel/Rectangle 28.png'

const Hotels = () => {
  return (
    <div className='text-left mt-36 mb-10'>
            <p>252 stays Apr 13-17 3 guests</p>
            <h4 className='text-2xl'>Stay in Cox's Bazar</h4>
            <div className="grid md:grid-cols-2 gap-5">
               ...
               <div className='grid md:grid-cols-2 gap-4 mb-5'>
                ...
                <iframe className='w-full h-screen rounded-lg' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118830.37960961302!2d91.92032837588945!3d21.450877897260806!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30adc7ea2ab928c3%3A0x3b539e0a68970810!2sCox&#39;s%20Bazar!5e0!3m2!1sen!2sbd!4v1682938888767!5m2!1sen!2sbd" width="200" height="100" allowfullscreen="" loading="lazy" ></iframe>
                </div>
            </div>
        </div>
  );
